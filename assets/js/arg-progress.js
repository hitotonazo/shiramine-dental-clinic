(() => {
  'use strict';
  const keys = { phase: 'shiraminePhase', foundPhase1: 'shiramineFoundPhase1', life: 'shiramineLifeRecordOpened', others: 'shiramineOtherSubjectsViewed', residents: 'shiramineAllResidentsViewed', oldest: 'shiramineOldestRecordViewed', archive: 'shiramineArchiveRevealed', ending: 'shiramineEnding' };
